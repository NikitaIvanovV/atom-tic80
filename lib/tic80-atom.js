...
export default {
  ...
  activate(state) {
    ...
    this.terminal = new TerminalView({
      clearConsole: getConfig('terminal.clearConsole'),
    ...
    this.tic80 = new Tic80(
      ...
      onClose: () => {
        if (getConfig('terminal.closeTerminalOnExit')) { this.terminal.close(); }
      }
    });
...
Default cart will be used.
    ...
    this.runTic80(cartPath, codePath);
  },
    ...
    terminal: {
      ...
      properties: {
        ...
        closeTerminalOnExit: {
          ...
          description: "Whether close terminal when TIC-80 is exitted.",
          type: 'boolean',
          default: false
        },
        position: {
